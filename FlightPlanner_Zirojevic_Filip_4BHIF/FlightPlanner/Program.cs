    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                BookingDataMapper booktest = new BookingDataMapper(connectionString);
                booktest.Create(new Booking(204, 1500, 2, 2, 220));
                booktest.Read(204);
                booktest.Update(new Booking(204, 1500, 2, 2, 250));
                booktest.Delete(new Booking(204, 1500, 2, 2, 250));
